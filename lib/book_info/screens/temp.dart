...
//   Future<Map<String, dynamic>> fetchItem(String bookId) async {
//     try {
//       var url = Uri.parse('http://localhost:8080/json/$bookId/');
...
//             'jumlah_terjual': bookData['jumlah_terjual'],
//           };
//         } else {
//           return {};
//         }
...
//   //   for (var d in data) {
//   //     if (d != null && d['pk'] == int.parse(bookId)) {
//   //       buku = d;
//   //     }
//   //   }
//   //   return Book.fromJson(buku!);
//   // }
...
//               "http://localhost:8000/add-to-cart-flutter/",
